...
public class FilmoRateFilmApplicationTestsDb {
    ...
    public void FilmDbStorageTest() {
        ...
        Optional<List<Film>> userOptional1 = Optional.ofNullable(filmStorage.getFilms(0L));
        ...
        Optional<List<Film>> userOptional2 = Optional.ofNullable(filmStorage.getFilms(0L));
        ...
        Optional<List<Mpa>> userOptional4 = Optional.ofNullable(filmStorage.getRating());

        assertThat(userOptional4).isPresent().hasValueSatisfying(AssertionsForClassTypes::assertThat)
                .hasValue(Arrays.asList(new Mpa(1, "G"),
                        new Mpa(2, "PG"),
                        new Mpa(3, "PG-13"),
                        new Mpa(4, "R"),
                        new Mpa(5, "NC-17")));
